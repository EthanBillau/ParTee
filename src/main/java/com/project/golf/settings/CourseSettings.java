...
public class CourseSettings implements CourseSettingsInterface {
    ...
    public CourseSettings(String courseName, String openingTime, String closingTime,
                         double defaultPricePerPerson, int teeTimeInterval, 
                         int maxPartySize, int numberOfTeeBoxes, int advanceBookingDays) {
        this();
    ...
    public static CourseSettings fromFileString(String fileString) {
        ...
        try {
            ...
            CourseSettings settings = new CourseSettings(courseName, openingTime, closingTime,
                                                        defaultPrice, interval, maxParty,
                                                        numTeeBoxes, advanceBooking);
