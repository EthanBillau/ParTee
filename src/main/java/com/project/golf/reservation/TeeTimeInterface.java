 ...
 *
 * <p>Interface defining golf course tee time slot management and reservation booking. Specifies
 * contracts for tee time capacity and reservation operations.
 *
 * <p>Data structures: Tee time properties (ID, date, time, tee box, maxPartySize, price), ArrayList
 * of reservations for bookings. Algorithm: Capacity validation with party size checking, ArrayList
 * iteration for reservation management. Features: Tee time property access, reservation
 * booking/cancellation, capacity validation, party size calculation, file serialization.
 *
