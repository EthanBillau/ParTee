 ...
 *
 * <p>Interface defining golf course reservation data and operations. Specifies contracts for tee
 * time reservation management and state tracking.
 *
 * <p>Data structures: Reservation details (ID, user, date, time, party size, tee box, price),
 * payment and approval state flags. Algorithm: State tracking pattern with getter/setter accessors.
