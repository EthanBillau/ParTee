 ...
 * PasswordUtil.java
 *
 * <p>Utility class for secure password hashing and validation using BCrypt. Provides methods to
 * hash passwords and verify them against stored hashes.
 *
...
public class PasswordUtil {
  ...
  /**
   * Check if a string is a BCrypt hash BCrypt hashes start with "$2a$", "$2b$", or "$2y$"
   *
