 ...
 *
 * <p>Custom JPanel with full-coverage scaled background image rendering. Loads from classpath
 * resources with filesystem fallbacks for compatibility.
 *
 * <p>Data structures: BufferedImage for background, static String constants for resource paths
 * (classpath and filesystem alternatives). Algorithm: Image loading with fallback chain (classpath
 * → filesystem paths), scaling with aspect ratio preservation, high-quality rendering hints.
 * Features: Custom background image rendering, transparent overlay support, aspect ratio
 * preservation, multi-source image loading, IDE compatibility.
 *
