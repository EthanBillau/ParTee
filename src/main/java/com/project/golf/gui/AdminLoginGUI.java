 ...
 * AdminLoginGUI.java
 *
 * <p>Authentication interface for server administrators. Validates credentials and launches admin
 * control panel on success.
 *
 * <p>Data structures: JTextField for username, JPasswordField for password, JButton for login and
 * password visibility toggle. UserManager for authentication. Algorithm: Credential verification
 * against UserManager database, admin privilege check, conditional window launch based on
 * authentication result. Features: Username/password input with validation, password visibility
 * toggle, authentication with admin privilege verification, admin panel navigation.
 *
...
public class AdminLoginGUI extends JFrame implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    if (e.getSource() == loginButton) {
      ...
      /**
       * Toggle password visibility for easier admin login. Remove echo char to show plaintext, or
       * add it back to hide.
       */
  ...
  private void attemptLogin() {
    ...
    /**
     * Validate credentials through UserManager. Even if login succeeds, verify the user has admin
     * privileges.
     */
