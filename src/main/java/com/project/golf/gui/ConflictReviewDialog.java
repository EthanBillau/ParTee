 ...
 *
 * Modal conflict resolution dialog for event approval workflow.
 * Displays conflicting reservations and captures admin approval decision.
 *
 * Data structures: ArrayList of Reservations for conflicts, boolean approved flag
 * for decision tracking, JButton controls for user action.
 * Algorithm: Modal dialog displaying event details and conflict table with
 * user decision capture (approve/cancel) affecting internal state.
 * Features: Conflict display and review, admin confirmation dialog, decision persistence,
 * deletion impact warning, parent dialog modal relationship.
 *
...
public class ConflictReviewDialog extends JDialog implements ActionListener {
    ...
    public ConflictReviewDialog(JDialog parent, Event pendingEvent, ArrayList<Reservations> conflicts) {
        ...
        JLabel warningLabel = new JLabel("⚠ WARNING: The following conflicts will be " +
                                          "DELETED if you approve this event:");
        ...
        eventInfoPanel.add(new JLabel("Time: " + pendingEvent.getDate() + " " + pendingEvent.getTime() + 
            " to " + pendingEvent.getEndDate() + " " + pendingEvent.getEndTime()));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == approveButton) {
            int confirm = JOptionPane.showConfirmDialog(this, 
                "Are you SURE you want to delete " + conflicts.size() + " conflicting item(s)?\nThis cannot be undone!",
                "Final Confirmation", 
