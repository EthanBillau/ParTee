 ...
 *
 * Unit test suite for ServerWorker request handling and protocol parsing.
 * Tests command dispatching, response generation, and exception handling.
 *
 * Data structures: ServerWorker instances with mock connections, test request strings
 * in pipe-delimited protocol format, response strings.
 * Algorithm: JUnit 5 with mock socket/stream testing, protocol parsing validation.
 * Features: Command parsing, handler method invocation, response formatting,
 * protocol compliance, error handling and logging.
 *
...
public class ServerWorkerTest {
    ...
    void setUp() throws Exception {
        ...
        db.addUser(new User("testuser", "password123", "Test", "User",
        ...
        Event ev = new Event("E001", "Golf Tournament", "2025-11-25", "09:00", 
                            200, "All", 75.0, "2025-11-25", "12:00");
        db.addEvent(ev);
    }
    ...
    void testConstructorAcceptsSocket() {
        assertDoesNotThrow(() -> new ServerWorker(serverSocket),
                "Constructor should accept socket without throwing");
    }
    ...
    void testLoginWithInvalidCredentials() throws Exception {
        ...
        assertTrue(response.contains("Invalid credentials"), "Response should indicate invalid credentials");
    }
    ...
    void testLoginWithInsufficientArguments() throws Exception {
        ...
        assertTrue(response.contains("requires username and password"),
    ...
    void testListEvents() throws Exception {
        ...
        assertEquals("Golf Tournament", eventName, "Response should contain event name 'Golf Tournament'");
    }
    ...
    void testGetReservationsEmpty() throws Exception {
        ...
        assertEquals("RESP|OK|", response, "GET_RESERVATIONS with no reservations should return empty payload");
    }
