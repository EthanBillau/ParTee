 ...
 * 
 * Unit test suite for CourseSettings configuration management.
 * Tests operational parameters and business rule enforcement.
 *
 * Data structures: CourseSettings instances, day-of-week HashMap overrides.
 * Algorithm: JUnit 5 with boundary testing for time/price/party size constraints.
 * Features: Settings instantiation, operational hours validation, pricing configuration,
 * party size limits, advance booking policies, day-specific customization.
 *
...
public class CourseSettingsTest {
    ...
    public void testParameterizedConstructor() {
        CourseSettings custom = new CourseSettings(
            "Pebble Beach",
            "06:00",
            "20:00",
            50.0,
    ...
    public void testRoundTripPersistence() {
        CourseSettings original = new CourseSettings(
            "Test Course",
            "08:00",
            "17:00",
            35.0,
