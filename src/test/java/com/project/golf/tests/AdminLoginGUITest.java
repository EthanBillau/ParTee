 ...
 *
 * Comprehensive JUnit test suite for AdminLoginGUI class.
 * Tests constructors, GUI component initialization, layout, 
 * components, visibility, and properties for admin authentication.
...
public class AdminLoginGUITest {
    ...
    public void testAdminLoginGUIImplementsActionListener() {
        AdminLoginGUI gui = new AdminLoginGUI();
        assertTrue(gui instanceof java.awt.event.ActionListener, 
    ...
    public void testAdminLoginGUIHasDefaultCloseOperation() {
        ...
        assertEquals(JFrame.EXIT_ON_CLOSE, closeOp, 
                     "AdminLoginGUI should have EXIT_ON_CLOSE");
        gui.dispose();
    }
    ...
    public void testAdminLoginGUIHasGreenBackground() {
        ...
        assertEquals(new Color(34, 139, 34), backgroundColor, 
    ...
    public void testAdminLoginGUIUsesBoxLayout() {
        ...
        assertTrue(layout instanceof BoxLayout, 
                   "AdminLoginGUI content pane should use BoxLayout");
    ...
    public void testAdminLoginGUIHasButtons() {
        ...
        assertTrue(buttonCount >= 2, 
                   "AdminLoginGUI should have at least 2 buttons (login and show/hide)");
        gui.dispose();
    }
    ...
    public void testAdminLoginGUIHasLabels() {
        ...
        assertTrue(labelCount >= 3, 
                   "AdminLoginGUI should have at least 3 labels (title, username, password)");
        gui.dispose();
    }
    ...
    public void testAdminLoginGUITitleContainsAdminKeywords() {
        ...
        boolean hasAdminKeyword = title.contains("admin") || 
                                  title.contains("administrator") ||
                                  title.contains("manager");
        
        assertTrue(hasAdminKeyword, 
                  "AdminLoginGUI title should contain admin-related keywords");
        gui.dispose();
    }
    ...
    public void testAdminLoginGUITitleFormat() {
        ...
        assertEquals("Admin Login - Golf Server", title, 
                     "AdminLoginGUI title should match expected format");
    ...
    public void testAdminLoginGUIDispose() {
        ...
        assertDoesNotThrow(() -> gui.dispose(), 
                          "AdminLoginGUI should dispose without exceptions");
    }
