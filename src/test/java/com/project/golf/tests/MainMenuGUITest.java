 ...
 *
 * <p>Unit test suite for MainMenuGUI constructor and component initialization. Tests navigation
 * buttons and frame configuration.
 *
 * <p>Data structures: MainMenuGUI instance, JButton components for navigation. Algorithm: JUnit 5
 * with reflection-based component verification. Features: Constructor validation, button
 * initialization, frame properties, component verification per project requirements.
 *
...
public class MainMenuGUITest {
  ...
  public void testFrameProperties() {
    assertEquals(
        "Golf Course Reservation System - Main Menu",
        mainMenuGUI.getTitle(),
        "Frame title should match");
    assertEquals(
        JFrame.EXIT_ON_CLOSE,
        mainMenuGUI.getDefaultCloseOperation(),
  ...
  public void testMakeReservationButtonExists() throws Exception {
    ...
    assertEquals("Make Reservation", button.getText(), "Make reservation button text should match");
  }
  ...
  public void testManageReservationButtonExists() throws Exception {
    ...
    assertEquals(
        "Manage Reservation", button.getText(), "Manage reservation button text should match");
  }
  ...
  public void testAccountOptionsButtonExists() throws Exception {
    ...
    assertEquals("Account Options", button.getText(), "Account options button text should match");
  }
