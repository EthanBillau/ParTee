 ...
 * TeeTimeTest.java
 * 
 * Unit test suite for TeeTime slot creation and reservation management.
 * Tests capacity validation, party size limits, and booking operations.
 *
 * Data structures: TeeTime objects, Reservations for bookings, ArrayList of reservations.
 * Algorithm: JUnit 5 with boundary testing for capacity limits and party size validation.
 * Features: TeeTime creation validation, price calculation, capacity checking, reservation adding,
 * ID generation, slot availability verification.
 *
...
public class TeeTimeTest {
    ...
    public void testEquals() {
        TeeTime same = new TeeTime(teeTime.getTeeTimeId(), "2025-11-15", 
                                    "09:00", "Hole 1", 4, 30.0);
