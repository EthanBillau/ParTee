 ...
 * UserTest.java
 *
 * Unit test suite for User class functionality and edge cases.
 * Tests user creation, property access, and serialization operations.
 *
 * Data structures: User objects with various profile configurations for test cases.
 * Algorithm: JUnit 5 parametrized testing pattern with assertion-based verification.
 * Features: User instantiation validation, property getter verification, toString() formatting,
 * password storage, admin/payment status flags.
 *
