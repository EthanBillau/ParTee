 ...
 * LoginGUITest.java
 *
 * <p>Unit test suite for LoginGUI constructor and component initialization. Tests GUI creation,
 * field initialization, and component configuration.
 *
 * <p>Data structures: LoginGUI instance, JTextField/JPasswordField/JButton components. Algorithm:
 * JUnit 5 with reflection-based component verification. Features: Constructor validation, component
 * initialization, frame properties, button and field verification per project requirements.
 *
...
public class LoginGUITest {
  ...
  public void testFrameProperties() {
    assertEquals("Golf Course Reservation System", loginGUI.getTitle(), "Frame title should match");
    assertEquals(
        JFrame.EXIT_ON_CLOSE,
        loginGUI.getDefaultCloseOperation(),
