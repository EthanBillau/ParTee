 ...
 * ClientTest.java
 *
 * <p>Unit test suite for Client network communication and protocol handling. Tests server
 * connection, request sending, and response parsing.
 *
 * <p>Data structures: Client instances, Socket/stream mocks, request/response strings in
 * pipe-delimited protocol format. Algorithm: JUnit 5 with mock networking, protocol string parsing,
 * I/O exception handling. Features: Connection establishment, server communication, protocol
 * compliance, request formatting, response handling, exception propagation.
 *
