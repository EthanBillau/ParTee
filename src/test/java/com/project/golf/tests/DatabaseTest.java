 ...
 * DatabaseTest.java
 *
 * <p>Unit test suite for Database Singleton operations and persistence. Tests
 * user/reservation/event data operations and file synchronization.
 *
 * <p>Data structures: Database instance (Singleton), ArrayLists for data storage, file-based
 * persistence with pipe-delimited format. Algorithm: JUnit 5 with Singleton pattern validation,
 * file I/O testing, state isolation. Features: Database getInstance(), CRUD operations, file
 * loading/saving, thread-safe locking, data consistency validation, persistence synchronization.
 *
...
public class DatabaseTest {
  ...
  public void testValidateLogin() {
    ...
    assertTrue(
        database.validateLogin("john123", "password"), "Should validate correct credentials");
  ...
  public void testAddReservation() {
    Reservations res = new Reservations("R1", "john123", "2025-11-15", "09:00", 4, "Hole 1", 120.0);
  ...
  public void testAddDuplicateReservation() {
    Reservations res1 =
        new Reservations("R1", "john123", "2025-11-15", "09:00", 4, "Hole 1", 120.0);
    Reservations res2 = new Reservations("R1", "jane456", "2025-11-16", "10:00", 2, "Hole 2", 60.0);
  ...
  public void testRemoveNonexistentReservation() {
    assertFalse(
        database.removeReservation("R999"), "Should return false for nonexistent reservation");
  }
  ...
  public void testGetReservationsByUser() {
    Reservations res1 =
        new Reservations("R1", "john123", "2025-11-15", "09:00", 4, "Hole 1", 120.0);
    Reservations res2 = new Reservations("R2", "john123", "2025-11-16", "10:00", 2, "Hole 2", 60.0);
    Reservations res3 = new Reservations("R3", "jane456", "2025-11-15", "11:00", 3, "Hole 3", 90.0);
  ...
  public void testGetReservationsByDate() {
    Reservations res1 =
        new Reservations("R1", "john123", "2025-11-15", "09:00", 4, "Hole 1", 120.0);
    Reservations res2 = new Reservations("R2", "jane456", "2025-11-15", "10:00", 2, "Hole 2", 60.0);
    Reservations res3 = new Reservations("R3", "bob789", "2025-11-16", "11:00", 3, "Hole 3", 90.0);
  ...
  public void testGetAllReservations() {
    Reservations res1 =
        new Reservations("R1", "john123", "2025-11-15", "09:00", 4, "Hole 1", 120.0);
    Reservations res2 = new Reservations("R2", "jane456", "2025-11-16", "10:00", 2, "Hole 2", 60.0);
  ...
  public void testRemoveTeeTime() {
    ...
    assertTrue(
        database.removeTeeTime(teeTime.getTeeTimeId()), "Should remove tee time successfully");
    assertNull(
        database.findTeeTime(teeTime.getTeeTimeId()), "Tee time should not be found after removal");
  }

  @Test
  public void testRemoveNonexistentTeeTime() {
    assertFalse(database.removeTeeTime("TT999"), "Should return false for nonexistent tee time");
  }
  ...
  public void testClearAllData() {
    ...
    assertEquals(
        0, database.getAllReservations().size(), "Should have no reservations after clear");
  ...
  public void testConcurrentUserAddition() throws InterruptedException {
    ...
    assertEquals(numThreads, database.getAllUsers().size(), "Should have added all users safely");
  }
  ...
  public void testConcurrentReservationAddition() throws InterruptedException {
    ...
    assertEquals(
        numThreads,
        database.getAllReservations().size(),
