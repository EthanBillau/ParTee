 ...
 * EventTest.java
 *
 * Unit test suite for Event multi-day reservation creation and operations.
 * Tests event duration tracking and inherited reservation functionality.
 *
 * Data structures: Event objects extending Reservations, start/end date/time fields.
 * Algorithm: JUnit 5 with duration validation and inheritance testing.
 * Features: Event instantiation with duration, end date/time property access,
 * inherited reservation methods, date range validation.
 *
...
public class EventTest {
    ...
    @BeforeEach
    void setUp() {
        event = new Event("E001", "GolfTournament", "2025-12-15", "09:00", 
                         200, "All", 75.0, "2025-12-15", "12:00");
    }
    ...
    void testToFileString() {
        assertTimeout(ofMillis(1000), () -> {
            ...
            assertTrue(fileString.contains("GolfTournament"), "File string should contain event name");
